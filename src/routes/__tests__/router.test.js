...
describe('search route', () => {
  const makeRequest = async (query, spellCheck = true, algorithm = 'lucene') => {
    const options = {
  ...
  //
  //   describe('error', () => {
  //     it('throws error if request does not contain 3 parameters', async () => {
  //       const options = {
  //         uri: 'http://localhost:3000/search',
  //         qs: {
  //           q: 'search query'
  ...
  //     });
  //
  //     it('takes a misspelt query and corrects it if spellCorrect is true', async () => {
  //       try {
  //         res = await makeRequest('clmat chnge', true);
  //       } catch(err) {}
  //       res = JSON.parse(res.body);
  //       expect(res.corrected_query).toEqual('climate change');
  //     });
  //
  //     it('takes a misspelt query but doesnt not correct it if spellCorrect is false', async () => {
  //       try {
  //         res = await makeRequest('clmat chnge', false);
  //       } catch(err) {}
  //       res = JSON.parse(res.body);
  //       expect(res.corrected_query).toEqual('clmat chnge');
  //     });
  //
